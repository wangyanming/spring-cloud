...
public class AccessLogGlobalFilter implements GlobalFilter, Ordered {
    ...
    private final String REQUEST_PREFIX = "Request Info [ ";

    private final String REQUEST_TAIL = " ]";

    private final String RESPONSE_PREFIX = "Response Info [ ";

    private final String RESPONSE_TAIL = " ]";
